...
m2 <- lmerTest::lmer(HR_change_self ~ 0 + (HR_self + HR_other) : type +  (0 + type | participant) + (0 + type | group),  subset(df1, study=="4"), REML=F,control = lmerControl(optimizer = "nloptwrap", calc.derivs = FALSE))
