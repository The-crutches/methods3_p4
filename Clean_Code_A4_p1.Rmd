...
HR1 <- unique(as.list(as.complex(df_HR1$HR1)))
...
HR2 <- unique(as.list(as.complex(df_HR2$HR2)))
...
Resp1 <- unique(as.list(as.complex(df_Resp1$Resp1)))
...
Resp2 <- unique(as.list(as.complex(df_resp2$Resp2)))
