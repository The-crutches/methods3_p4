...
data_study1_synch = data %>% filter(study == 1 & type == 'Synchronous')
data_study1_group11 = data %>% filter(study == 1 & group == 11)

library(lme4)
doParallel::registerDoParallel()

m1 = lmer(HR_change_self ~ 0 + (HR_self + HR_other)*type + (0 + type|ID), REML = F, control = lmerControl(optimizer = "nloptwrap", calc.derivs = FALSE), data = data_study1_group11)
