...
#divide time by 60.0000 in study 3 and 4
data$time <- ifelse(data$study == 3, data$time /60000, data$time)
data$time <- ifelse(data$study == 4, data$time /60000, data$time)
...
# Remove bad data
  ...
  # time is really on a horrible scale for study 4
